...
**🚀 New Features & Fixes**
* **MCP Server Management**: Added ability to switch between MCP servers directly through KubeSpotlight for streamlined workflow.
* **MCP Server Toggle**: Implemented enable/disable functionality for MCP servers with instant UI feedback and optimized backend synchronization.
...
**✨ Improvements**
* **MCP Spotlight Integration**: Enhanced MCP server discovery and management through the spotlight interface with real-time server status updates.
