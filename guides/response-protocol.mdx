...
### Quickstart
Here’s a quick sample of a Response Protocol that you can import into your Agentkube dashboard to get started. Use this as a foundation to create your own custom protocol based on your cluster’s needs: [Kubernetes Resource Health Check Protocol](https://raw.githubusercontent.com/agentkube/docs/refs/heads/main/examples/health-check-protocol.yaml)
