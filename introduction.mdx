---
title: Introduction
description: "AI-powered Kubernetes Management IDE for Developers and DevOps Teams"
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="discord"
    href="https://discord.gg/UxnwzcjMWA"
  >
    Get help, explore features, and learn from other Kubernetes users.
  </Card>
</CardGroup>